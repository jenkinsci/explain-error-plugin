...
class ConsolePageDecoratorTest {
    ...
    @Test
    void testIsExplainErrorEnabledWithEmptyApiUrl() {
        config.setApiUrl("");
        
        // Should return false when API URL is empty
        assertFalse(decorator.isExplainErrorEnabled());
    }

    @Test
    void testIsExplainErrorEnabledWithBlankApiUrl() {
        config.setApiUrl("   ");
        
        // Should return false when API URL is blank
        assertFalse(decorator.isExplainErrorEnabled());
    }
    ...
    void testPartiallyValidConfig() {
        ...
        config.setEnableExplanation(true);
        config.setApiKey(Secret.fromString("valid-key"));
    ...
    void testAnotherPartiallyValidConfig() {
        ...
        config.setApiUrl("https://valid.url");
    ...
    @Test
    void testEdgeCaseApiUrl() {
        // Test with various edge cases for API URL
        config.setApiUrl("http://example.com"); // HTTP instead of HTTPS
        assertTrue(decorator.isExplainErrorEnabled()); // Should still work, validation is elsewhere
